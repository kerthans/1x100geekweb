...
// 'use client' 是 Next.js 13+ 的用法，确保此组件在客户端运行
'use client';
...
// 假设你有一些样式类定义在全局样式中
const styles = {
  navbar: 'fixed top-0 left-0 right-0 z-50 bg-white shadow-lg',
  navbarContainer: 'container mx-auto px-4 py-3 flex justify-between items-center',
  menuButton: 'block md:hidden',
  menuItem: 'block md:inline-block mt-4 md:mt-0 md:ml-4 no-underline text-gray-800 hover:text-gray-600',
  // 添加更多样式类...
};
